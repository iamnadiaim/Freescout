                            ...
                            <div id="reply-{{ $reply->id }}" class="collapse">
                                <div class="saved-reply-body">
                                    ...
                                    <form class="saved-reply-form" method="POST"
                                        action="{{ route('poliwangisavedreply.saved_replies.update', [
                                            'id' => $mailbox->id,
                                            'reply_id' => $reply->id,
                                        ]) }}">
                                            ...
                                            <div class="saved-reply-control">
                                                ...
                                                @else
                                                    <div
                                                        ...
                                                        @include('poliwangisavedreply::partials.toolbar')
                                    ...
                                    <form id="delete-reply-{{ $reply->id }}" method="POST"
                                        action="{{ route('poliwangisavedreply.saved_replies.destroy', [
                                            'id' => $mailbox->id,
                                            'reply_id' => $reply->id,
                                        ]) }}"
                                        style="display: none;">
...
@section('body_bottom')
    ...
    <div class="modal fade" id="savedReplyCreateForm" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog saved-reply-create" role="document">
            <div class="modal-content">
                ...
                <form class="saved-reply-form" method="POST"
                    action="{{ route('poliwangisavedreply.saved_replies.store', ['id' => $mailbox->id]) }}">
                    {{ csrf_field() }}
    ...
    @include('poliwangisavedreply::partials.image_modal')

@endsection

@section('stylesheets')
    @parent
    <link href="{{ asset('css/saved-replies.css') }}" rel="stylesheet">
@endsection
