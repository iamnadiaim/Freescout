...
@section('content')
    @if (!\Module::isActive('poliwangitimetracking'))
        <div style="padding: 20px; margin-top: 10px;">
            <div style="font-size: 18px; color: #555;">
                To view the Time Tracking Report you need to install <a href="{{ route('modules') }}">Time Tracking Module</a>.
            </div>
        </div>
    @else
    <style>
    ...
    <div class="tt-report-page">
        ...
        <div class="tt-report-header">
            <div class="tt-report-header-row">
                ...
                <form method="GET" action="{{ route('PoliwangiPortal.reports.time_tracking') }}" class="tt-filter-form">
                    ...
                    <div class="tt-filter-main">
                        ...
                        <span class="tt-filter-actions">
                            ...
                            <a href="{{ route('PoliwangiPortal.reports.time_tracking') }}" class="tt-btn tt-btn-light"
                                title="Reset">
                    ...
                    {{-- BARIS KEDUA: FILTER TAMBAHAN DARI MODULE LAIN (GENERIC HOOK) --}}
                    <div class="tt-filter-custom">
                        @php
                            \Eventy::action('report.render_filters', $selectedMailboxId, request());
                        @endphp
                    </div>
                </form>
            </div>
