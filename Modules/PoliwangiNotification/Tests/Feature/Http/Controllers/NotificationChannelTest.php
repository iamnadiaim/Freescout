...
class NotificationChannelTest extends TestCase
{
    ...
    public function test_test_channel_success()
    {
        ...
        $mockService = new class(
            app(\Modules\PoliwangiNotification\Services\Notifications\NotificationSenderFactory::class),
    ...
    public function test_webhook_success()
    {
        ...
        $mockFactory = new class extends \Modules\PoliwangiNotification\Services\Notifications\NotificationWebhookFactory {
        ...
        $controller = new \Modules\PoliwangiNotification\Http\Controllers\NotificationChannelController(
            app(\Modules\PoliwangiNotification\Services\Notifications\NotificationSenderFactory::class),
            app(\Modules\PoliwangiNotification\Services\Notifications\NotificationService::class),
            $mockFactory
        );
    ...
    public function test_authorize_admin_direct_call()
    {
        ...
        $controller = app(\Modules\PoliwangiNotification\Http\Controllers\NotificationChannelController::class);
        $controller->index();
    }
    ...
    public function test_store_config_branches()
    {
        ...
        $mockFactory = new class extends \Modules\PoliwangiNotification\Services\Notifications\NotificationSenderFactory {
            public function supportedTypes() { return ['telegram']; }
            public function rules($type) { return ['bot_token' => 'nullable', 'chat_id' => 'nullable']; }
        };
        $this->app->instance(\Modules\PoliwangiNotification\Services\Notifications\NotificationSenderFactory::class, $mockFactory);
