...
class EndUserPortalTest extends TestCase
{
    ...
    {
        $response = $this->get(route('PoliwangiPortal.end_user_portal.auth_select'));
        $response->assertStatus(200);
        $response->assertViewIs('poliwangiportal::end_user_portal.auth_select');
    }

    public function test_select_mailbox_redirects_to_show_portal()
    {
        $response = $this->get(route('PoliwangiPortal.end_user_portal.select_mailbox'));
        $response->assertStatus(200);
        $response->assertViewIs('poliwangiportal::end_user_portal.submit_ticket');
    }

    public function test_show_portal_with_mailbox_id()
    {
        $response = $this->get(route('PoliwangiPortal.end_user_portal.submit_ticket', ['mailbox_id' => $this->mailbox->id]));
    ...
    public function test_submit_ticket_validation_fails()
    {
        ...
        $response = $this->post(route('PoliwangiPortal.end_user_portal.submit', ['mailbox_id' => $this->mailbox->id]), [
            // empty payload
        ]);
    ...
    {
        $response = $this->get(route('PoliwangiPortal.end_user_portal.login_end_user'));
        $response->assertStatus(200);
        $response->assertViewIs('poliwangiportal::end_user_portal.login_end_user');
    }

    public function test_login_end_user_submit_invalid_credentials()
    {
        $this->withExceptionHandling();
        $response = $this->post(route('PoliwangiPortal.end_user_portal.login.submit'), [
    ...
    public function test_logout_end_user()
    {
        ...
        $response = $this->get(route('PoliwangiPortal.end_user_portal.logout', ['redirect' => '/help']));
    ...
    public function test_login_end_user_submit_wrong_password()
    {
        ...
        \Modules\PoliwangiPortal\Models\EndUserPortalAccount::create([
            'customer_id' => $customerId,
            'email_id' => $emailId,
            'auth_type' => 'password',
    ...
    {
        $response = $this->get(route('PoliwangiPortal.end_user_portal.register'));
        $response->assertStatus(200);
        $response->assertViewIs('poliwangiportal::end_user_portal.register_end_user');
    }

    public function test_register_end_user_submit_validation_fails()
    {
        $this->withExceptionHandling();
        $response = $this->post(route('PoliwangiPortal.end_user_portal.register.submit'), [
            // empty payload
        ]);
    ...
    {
        $response = $this->get(route('PoliwangiPortal.end_user_portal.verify', ['token' => 'invalid-token']));
        $response->assertRedirect(route('PoliwangiPortal.end_user_portal.login_end_user'));
        $response->assertSessionHasErrors(['email']);
    }
    ...
    public function test_verify_email_success()
    {
        ...
        $account = \Modules\PoliwangiPortal\Models\EndUserPortalAccount::create([
            'customer_id' => $customerId,
            'email_id' => $emailId,
            'auth_type' => 'password',
            'password' => \Illuminate\Support\Facades\Hash::make('password'),
        ...
        $response = $this->get(route('PoliwangiPortal.end_user_portal.verify', ['token' => 'valid-token-123', 'redirect' => '/help']));
    ...
    {
        $response = $this->get(route('PoliwangiPortal.end_user_portal.my_ticket'));
        $response->assertStatus(200);
        $response->assertViewIs('poliwangiportal::end_user_portal.track_ticket');
    }
    ...
    public function test_my_tickets_displays_tickets()
    {
        ...
        $response = $this->get(route('PoliwangiPortal.end_user_portal.my_ticket'));
        $response->assertStatus(200);
        $response->assertViewIs('poliwangiportal::end_user_portal.my_ticket');
    ...
    {
        $response = $this->get(route('PoliwangiPortal.end_user_portal.ticket_detail', [$this->mailbox->id, 999]));
        $response->assertRedirect();
        $response->assertSessionHasErrors(['email']);
    }
    ...
    public function test_ticket_detail_displays_conversation()
    {
        ...
        $response = $this->get(route('PoliwangiPortal.end_user_portal.ticket_detail', [$this->mailbox->id, $conversation->id]));
        $response->assertStatus(200);
        $response->assertViewIs('poliwangiportal::end_user_portal.ticket_detail');
    ...
    {
        $response = $this->post(route('PoliwangiPortal.end_user_portal.ticket_reply', [$this->mailbox->id, 999]), [
            'message' => 'Test reply',
        ]);
        $response->assertRedirect();
        $response->assertSessionHasErrors(['email']);
    ...
    public function test_reply_ticket_success()
    {
        ...
        $response = $this->post(route('PoliwangiPortal.end_user_portal.ticket_reply', [$this->mailbox->id, $conversation->id]), [
    ...
    {
        $response = $this->get(route('PoliwangiPortal.end_user_portal.sso.poliwangi'));
        $response->assertRedirect();
        $response->assertSessionHasErrors(['email']);
    }
    ...
    {
        $response = $this->get(route('PoliwangiPortal.end_user_portal.sso.poliwangi.callback'));
        $response->assertRedirect();
        $response->assertSessionHasErrors(['email']);
    }
    ...
    public function test_submit_ticket_with_notification_channel()
    {
        ...
        \Modules\PoliwangiNotification\Models\NotificationChannel::create([
            'mailbox_id' => $this->mailbox->id,
            'type' => 'telegram',
            'is_active' => true,
            'name' => 'Test Telegram',
    ...
    public function test_submit_ticket_logged_in_with_attachments_and_custom_fields()
    {
        ...
        $setting = \Modules\PoliwangiPortal\Models\EndUserPortalSetting::firstOrCreate(
            ['mailbox_id' => $this->mailbox->id],
    ...
    public function test_reply_ticket_with_attachments()
    {
        ...
        $response = $this->post(route('PoliwangiPortal.end_user_portal.ticket_reply', [$this->mailbox->id, $conversationId]), [
    ...
    {
        $controller = app(\Modules\PoliwangiPortal\Http\Controllers\EndUserPortalController::class);
        $reflection = new \ReflectionClass($controller);
        $method = $reflection->getMethod('safeRedirect');
        $method->setAccessible(true);

        $defaultRoute = route('PoliwangiPortal.end_user_portal.my_ticket');
    ...
    public function test_show_portal_without_mailboxes_returns_404()
    {
        ...
        $response = $this->get(route('PoliwangiPortal.end_user_portal.submit_ticket', ['mailbox_id' => 999]));
    ...
    public function test_show_portal_with_null_mailbox_id_uses_first_mailbox()
    {
        ...
        $this->assertEquals('poliwangiportal::end_user_portal.submit_ticket', $view->name());
    ...
    public function test_submit_ticket_custom_fields_branches()
    {
        ...
        $cf1 = CustomField::create([
            'mailbox_id' => $this->mailbox->id,
            'nama_field' => 'Text Field',
            'type_field' => 'text',
        ]);
        
        $cf2 = CustomField::create([
            'mailbox_id' => $this->mailbox->id,
            'nama_field' => 'Array Field',
            'type_field' => 'checkbox',
        ]);
        ...
        $val2 = \Modules\PoliwangiCustomField\Models\CustomFieldValue::where('conversation_id', $conversation->id)
        ...
        $val1 = \Modules\PoliwangiCustomField\Models\CustomFieldValue::where('conversation_id', $conversation->id)
    ...
    {
        $this->withExceptionHandling();
        $response = $this->post(route('PoliwangiPortal.end_user_portal.track.submit'), []);
        $response->assertRedirect();
    ...
    public function test_track_ticket_submit_with_tracking_code_success()
    {
        ...
        $response->assertRedirect(route('PoliwangiPortal.end_user_portal.track_detail', $number));
    ...
    {
        $this->markTestSkipped('Mockery is incompatible with PHP 8 Reflection parameter deprecations, skipping this test.');
        $this->withExceptionHandling();
        
        \Illuminate\Support\Facades\Mail::shouldReceive('send')->andThrow(new \Exception('Mocked Failure'));
    ...
    {
        $this->withExceptionHandling();
        $response = $this->get(route('PoliwangiPortal.end_user_portal.track.verify', ['token' => 'INVALIDTOKEN']));
        $response->assertRedirect(route('PoliwangiPortal.end_user_portal.my_ticket'));
        $response->assertSessionHasErrors(['message']);
    }
    ...
    public function test_verify_tracking_token_success()
    {
        ...
        $response = $this->get(route('PoliwangiPortal.end_user_portal.track.verify', ['token' => $token]));
        $response->assertRedirect(route('PoliwangiPortal.end_user_portal.track_detail', 123456));
    ...
    public function test_track_ticket_detail_unauthenticated()
    {
        ...
        $conversation->refresh();
        $number = $conversation->number;
        $response = $this->get(route('PoliwangiPortal.end_user_portal.track_detail', $number));
        $response->assertRedirect(route('PoliwangiPortal.end_user_portal.my_ticket'));
        $response->assertSessionHasErrors(['message']);
    }
    ...
    public function test_track_ticket_detail_authenticated_session()
    {
        ...
        $response = $this->get(route('PoliwangiPortal.end_user_portal.track_detail', $number));
        $response->assertStatus(200);
        $response->assertViewIs('poliwangiportal::end_user_portal.track_ticket_detail');
    }
    ...
    public function test_track_ticket_reply_unauthenticated()
    {
        ...
        $response = $this->post(route('PoliwangiPortal.end_user_portal.track_reply', $number), [
            'message' => 'Hello reply'
        ]);
        $response->assertRedirect(route('PoliwangiPortal.end_user_portal.my_ticket'));
    }
    ...
    public function test_track_ticket_detail_and_reply_via_customer_email_fallback()
    {
        ...
        $replyResponse = $this->post(route('PoliwangiPortal.end_user_portal.track_reply', $number), [
