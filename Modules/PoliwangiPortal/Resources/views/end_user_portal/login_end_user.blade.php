...
<head>
    <meta charset="UTF-8">
    <title>Log In - Poliwangi Portal</title>
    ...
    <div class="login-page">
        ...
        <div class="login-card">
            ...
            <p class="login-subtitle">
                Masuk ke akun pelapor Poliwangi Portal.
            </p>

            <form method="POST" action="{{ route('PoliwangiPortal.end_user_portal.login.submit') }}">
                {{ csrf_field() }}
                ...
                <div class="login-link">
                    Belum punya akun?
                    <a href="{{ route('PoliwangiPortal.end_user_portal.register', ['redirect' => $redirectUrl]) }}">
                        Daftar di sini
                    </a>
                </div>
