...
<head>
    <meta charset="UTF-8">
    <title>Daftar Akun Pelapor - Poliwangi Portal</title>
...
<div class="register-box">
    ...
    <form method="POST" action="{{ route('PoliwangiPortal.end_user_portal.register.submit') }}">
        {{ csrf_field() }}
    ...
    <div class="login-link">
        Sudah punya akun?
        <a href="{{ route('PoliwangiPortal.end_user_portal.login_end_user', ['redirect' => $redirectUrl]) }}">
            Login di sini
        </a>
    </div>
