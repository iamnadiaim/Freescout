@php
    ...
    $submitUrl = $navbarMailbox ? route('PoliwangiPortal.end_user_portal.submit_ticket', $navbarMailbox->id) : url('/help');

    $myTicketUrl = route('PoliwangiPortal.end_user_portal.my_ticket');

    $loginUrl = route('PoliwangiPortal.end_user_portal.auth_select', [
        'redirect' => $currentUrl,
    ]);

    $logoutUrl = route('PoliwangiPortal.end_user_portal.logout', [
        'redirect' => $homeUrl,
    ]);
@endphp
...
<div class="portal-navbar">
    <div class="brand">
        ...
        <div class="brand-text">
            <div class="brand-title">Poliwangi Portal</div>
    ...
    <div class="portal-menu">
        <a href="{{ $submitUrl }}"
            class="{{ request()->routeIs('PoliwangiPortal.end_user_portal.submit_ticket') ? 'active' : '' }}">
            Submit Ticket
        </a>

        <a href="{{ $myTicketUrl }}"
            class="{{ request()->routeIs('PoliwangiPortal.end_user_portal.my_ticket') ? 'active' : '' }}">
            Cek Status
        </a>
        ...
        @else
            <a href="{{ $loginUrl }}"
                class="portal-login-link {{ request()->routeIs('PoliwangiPortal.end_user_portal.login_end_user') ? 'active' : '' }}">
