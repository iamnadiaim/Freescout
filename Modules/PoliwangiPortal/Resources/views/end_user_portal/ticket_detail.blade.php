...
<body>
    ...
    <div class="ticket-detail-page">
        ...
        <div class="detail-header">
            <a href="{{ route('PoliwangiPortal.end_user_portal.my_ticket', $mailbox->id) }}" class="back-link">
                &laquo; My Tickets
            </a>
            ...
            @foreach ($threads as $thread)
                ...
                <div class="thread-item {{ $isCustomer ? 'customer' : 'user' }}">
                    ...
                    <div class="thread-content">
                        ...
                        {{-- HOOK: End-User Portal Thread Footer --}}
                        {!! \Eventy::action('portal.ticket.thread_footer', $thread, $mailbox, $conversation, $email) !!}
                    </div>
                </div>
            @endforeach
        </div>
        ...
        @if (!$isClosed)
            <div class="reply-box">
                <form method="POST"
                    action="{{ route('PoliwangiPortal.end_user_portal.ticket_reply', [$mailbox->id, $conversation->id]) }}"
