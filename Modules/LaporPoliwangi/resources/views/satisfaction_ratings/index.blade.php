    ...
    <div class="container">
        ...
        <div class="tab-content satisfaction-tab-content">
            ...
            <div role="tabpanel" class="tab-pane {{ $activeTab == 'settings' ? 'active' : '' }}" id="settings">
                ...
                <form method="POST" action="{{ route('laporpoliwangi.satisfaction_ratings.update_settings', $mailbox->id) }}"
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            ...
                            <a href="{{ route('laporpoliwangi.satisfaction_ratings.report', $mailbox->id) }}"
                ...
                <form method="POST" action="{{ route('laporpoliwangi.satisfaction_ratings.reset_settings', $mailbox->id) }}"
            ...
            <div role="tabpanel" class="tab-pane {{ $activeTab == 'translate' ? 'active' : '' }}" id="translate">
                ...
                <form method="POST" action="{{ route('laporpoliwangi.satisfaction_ratings.update_translate', $mailbox->id) }}"
                    class="form-horizontal satisfaction-form">
                ...
                <form method="POST" action="{{ route('laporpoliwangi.satisfaction_ratings.reset_translate', $mailbox->id) }}"
                    style="margin-top:15px;" onsubmit="return confirm('Reset Satisfaction Ratings ke default?')">
                    {{ csrf_field() }}
