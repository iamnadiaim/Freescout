@php
    $satisfactionRatingSetting = \Modules\LaporPoliwangi\Models\SatisfactionRatingSetting::where('mailbox_id', $mailbox->id)->first();

    $satisfactionRatings = \Modules\LaporPoliwangi\Models\SatisfactionRating::where('conversation_id', $conversation->id)
        ->get()
        ->keyBy('thread_id');
