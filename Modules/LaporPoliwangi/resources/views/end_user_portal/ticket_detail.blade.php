...
<body>
    ...
    <div class="ticket-detail-page">
        ...
        <div class="detail-header">
            <a href="{{ route('laporpoliwangi.end_user_portal.my_ticket', $mailbox->id) }}" class="back-link">
                &laquo; My Tickets
            </a>
                ...
                <div class="thread-item {{ $isCustomer ? 'customer' : 'user' }}">
                    ...
                    <div class="thread-content">
                        ...
                        @if ($showSatisfactionRating)
                            @php
                                $currentRating = isset($ratings[$thread->id]) ? $ratings[$thread->id] : null;
                            @endphp
                            ...
                            <div class="satisfaction-rating-box">
                                ...
                                <form method="POST" class="satisfaction-rating-form"
                                    action="{{ route('laporpoliwangi.end_user_portal.submit_satisfaction_rating', [$mailbox->id, $conversation->id]) }}">
                                    {{ csrf_field() }}
        ...
        @if (!$isClosed)
            <div class="reply-box">
                <form method="POST"
                    action="{{ route('laporpoliwangi.end_user_portal.ticket_reply', [$mailbox->id, $conversation->id]) }}"
