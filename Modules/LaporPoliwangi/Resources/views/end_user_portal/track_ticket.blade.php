...
<head>
    <meta charset="UTF-8">
    <title>Cek Status Tiket - Lapor Poliwangi</title>
    ...
    <div class="portal-home">
        ...
        <div class="track-container">
            ...
            <div id="tab-email" class="tab-pane active">
                <form action="{{ route('laporpoliwangi.end_user_portal.track.submit') }}" method="POST">
                    {{ csrf_field() }}
            ...
            <div class="login-prompt">
                Punya akun? <a href="{{ route('laporpoliwangi.end_user_portal.login_end_user', ['redirect' => route('laporpoliwangi.end_user_portal.my_ticket')]) }}">Login di sini</a> untuk melihat semua tiket Anda.
            </div>
        </div>
    </div>
