...
<html>
<head>
    <title>Verifikasi Akun Portal Lapor Poliwangi</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #f9f9f9; padding: 20px; border-radius: 8px; border: 1px solid #ddd;">
        ...
        <p>Terima kasih telah mendaftar di <strong>Portal Lapor Poliwangi</strong>. Untuk mengaktifkan akun portal Anda dan memastikan keamanan email Anda, silakan klik tombol verifikasi di bawah ini:</p>
        ...
        <p style="font-size: 12px; color: #777; margin-bottom: 0;">
            Jika Anda tidak merasa mendaftar di Portal Lapor Poliwangi, silakan abaikan email ini.<br>
