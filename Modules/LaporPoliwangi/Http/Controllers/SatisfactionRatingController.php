...
class SatisfactionRatingController extends Controller
{
    ...
    public function index($mailbox_id)
    {
        ...
        return view('laporpoliwangi::satisfaction_ratings.index', compact(
            'mailbox',
            'setting'
        ));
    }
    ...
    public function updateSettings(Request $request, $mailbox_id)
    {
        ...
        return redirect()
            ->to(route('laporpoliwangi.satisfaction_ratings.index', ['mailbox_id' => $mailbox->id]) . '?tab=settings')
    ...
    public function updateTranslate(Request $request, $mailbox_id)
    {
        ...
        return redirect()
            ->to(route('laporpoliwangi.satisfaction_ratings.index', ['mailbox_id' => $mailbox->id]) . '?tab=translate')
    ...
    public function submitRating(Request $request, $mailbox_id, $conversation_id)
    {
        ...
        if (!$setting || !$setting->enabled) {
            return redirect()
                ->route('laporpoliwangi.end_user_portal.ticket_detail', [$mailbox->id, $conversation_id])
                ->withErrors([
     ...
     */
        ...
        if (!$conversation) {
            return redirect()
                ->route('laporpoliwangi.end_user_portal.my_ticket')
                ->withErrors([
    ...
    public function rateFromEmail(Request $request, $mailbox_id, $conversation_id, $thread_id, $rating)
    {
        ...
        return view('laporpoliwangi::satisfaction_ratings.thank_you', [
            'mailbox' => $mailbox,
            'setting' => $setting,
            'rating'  => $rating,
        ]);
