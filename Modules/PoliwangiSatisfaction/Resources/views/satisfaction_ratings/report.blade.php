...
@section('content')
    <div class="container satisfaction-report-page">
            ...
            <div class="col-md-12">
                <div class="satisfaction-report-header">
                    ...
                    <div class="satisfaction-report-actions">
                        @if (\Modules\PoliwangiSatisfaction\Models\SatisfactionRating::where('mailbox_id', $mailbox->id)->count() > 0)
                            <a href="{{ route('PoliwangiPortal.satisfaction_ratings.export', ['mailbox_id' => $mailbox->id]) }}"
        ...
        @php
            ...
            $greatCount = \Modules\PoliwangiSatisfaction\Models\SatisfactionRating::where('mailbox_id', $mailbox->id)
                ->where('rating', 'great')
                ->count();

            $okayCount = \Modules\PoliwangiSatisfaction\Models\SatisfactionRating::where('mailbox_id', $mailbox->id)
                ->where('rating', 'okay')
                ->count();

            $notGoodCount = \Modules\PoliwangiSatisfaction\Models\SatisfactionRating::where('mailbox_id', $mailbox->id)
