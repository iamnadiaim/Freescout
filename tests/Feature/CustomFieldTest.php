...
class CustomFieldTest extends TestCase
{
    ...
    public function test_index_page_loads()
    {
        ...
        $response->assertViewIs('laporpoliwangi::custom_field');
        $this->assertStringContainsString('Jurusan', $response->getContent());
    }

    public function test_store_valid_text_field()
    {
        $response = $this->post(route('laporpoliwangi.custom_fields.store', ['mailbox_id' => $this->mailbox->id]), [
            'nama_field' => 'Fakultas',
            'type_field' => 'text',
            'required' => '1',
            '_token' => csrf_token(),
        ...
        $response->assertRedirect(route('laporpoliwangi.custom_fields', ['mailbox_id' => $this->mailbox->id]));
    ...
    public function test_update_valid_field()
    {
        ...
        $response = $this->put(route('laporpoliwangi.custom_fields.update', ['mailbox_id' => $this->mailbox->id, 'field_id' => $field->id]), [
    ...
    public function test_update_not_found_field()
    {
        ...
        $response = $this->put(route('laporpoliwangi.custom_fields.update', [$this->mailbox->id, 9999]), [
            'nama_field' => 'Ghost',
            'type_field' => 'text',
            '_token' => csrf_token(),
        ]);
    ...
    public function test_destroy_field()
    {
        ...
        $response = $this->delete(route('laporpoliwangi.custom_fields.destroy', ['mailbox_id' => $this->mailbox->id, 'field_id' => $field->id]), [
            '_token' => csrf_token(),
        ]);
    ...
    public function test_get_by_mailbox_json()
    {
        ...
        $response = $this->get(route('laporpoliwangi.custom_fields.json', ['mailbox_id' => $this->mailbox->id]));
